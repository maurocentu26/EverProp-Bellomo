...
final class UpdatePropertyRequest extends InventoryRequest
{
    ...
    public function rules(): array
    {
        ...
        return $this->serverOwnedRules() + [
            ...
            'operation' => ['sometimes', $this->sourceEnum('operation', PropertyOperation::class)],
            'category' => ['sometimes', $this->sourceEnum('category', PropertyCategory::class)],
            'status' => ['sometimes', $this->sourceEnum('status', PropertyStatus::class)],

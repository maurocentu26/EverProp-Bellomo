      ...
      <div className="flex flex-col gap-3 border-b border-slate-200 dark:border-slate-800 pb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="flex items-center gap-1 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-muted dark:border-slate-800 dark:text-slate-300 dark:hover:bg-slate-800"
          >
                              ...
                              <div className="flex items-center justify-end gap-1.5">
                                ...
                                {inst.status !== "PAID" && inst.status !== "CANCELLED" ? (
                                  <button
                                    ...
                                    className="flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-2 py-0.5 text-[11px] font-bold text-slate-700 hover:bg-muted dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
                                  >

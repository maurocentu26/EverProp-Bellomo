            ...
            <article key={lead.id} className="p-3.5 sm:p-4">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <select
                  ...
                  className={cn(
                    "cursor-pointer shrink-0 rounded-lg border px-2 py-1 text-[11px] font-bold focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:cursor-not-allowed disabled:opacity-70",
                    currentStage.class
                  )}
                >

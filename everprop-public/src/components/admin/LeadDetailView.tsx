        ...
        <div className="space-y-6 lg:col-span-8">
          ...
          <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-sm sm:p-6">
            {isMockDataMode && canUpdate ? (
              ...
              <div className="rounded-xl border border-amber-200 dark:border-amber-900 bg-amber-50 dark:bg-amber-950/20 px-4 py-5 text-sm text-amber-900 dark:text-amber-200" role="status">
                {isMockDataMode
